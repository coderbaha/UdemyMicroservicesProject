...
namespace FreeCourse.Services.Discount.Services.Concrete
{
    public class DiscountService : IDiscountService
    {
        ...
        {
            var status = await _dbConnection.ExecuteAsync("update discount set userid=@UserId, code=@Code, rate=@Rate where id=@Id", new { discount.Id, discount.UserId, discount.Code, discount.Rate });
